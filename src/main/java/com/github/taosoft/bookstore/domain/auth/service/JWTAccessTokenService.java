package com.github.taosoft.bookstore.domain.auth.service;
 ...
 * 令牌服务应当会被授权服务器{@link com.github.taosoft.bookstore.infrastructure.configuration.AuthorizationServerConfiguration}注册验证Endpoint时候调用到
 **/
@Named
